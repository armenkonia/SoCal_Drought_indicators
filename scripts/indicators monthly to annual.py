...
# filtered_df = df.loc[df.index >= '1990']
filtered_df = col_div_cu.reset_index()
...
filtered_df_wy = filtered_df.groupby('water_year')[list(filtered_df.columns)[2:10]].sum().reset_index()
# plt.plot(socal_sw['date'],socal_sw['SWDI'])
